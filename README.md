...
## 项目来源
项目：[sso-shiro-cas](https://github.com/coder-huang/sso-shiro-cas)
...
3.在/node1/src/main/resources/conf/shiro.xml 文件中
``` xml
<!-- Shiro Filter -->
...
最后我们还需要在/node1/src/main/webapp/WEB-INF/web.xml 文件中配置相关的过滤器拦截全部请求
``` xml
<filter>
